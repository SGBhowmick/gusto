...
class AppConstants {
  static const String appName = 'Dusto';
  static const String appVersion = '1.0.0';

  /// Flutter SDK : 3.38.1
  static const String baseUrl = 'https://dusto.ae';
  static const String websiteUrl =
      'https://dusto.ae'; // Replace with your actual web site URL : ex: https://demandium-web.6amtech.com
  ...
  static const String subscriptionPlansUri =
      '/api/v1/customer/wash-subscription/plans';
  static const String currentSubscriptionUri =
      '/api/v1/customer/wash-subscription/current';
  static const String subscriptionCheckoutUri =
      '/api/v1/customer/wash-subscription/checkout';
