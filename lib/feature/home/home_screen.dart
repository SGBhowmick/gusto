...
import 'package:dusto/feature/home/widget/nearby_provider_listview.dart';
...
class _HomeScreenState extends State<HomeScreen> {
  ...
  void initState() {
    ...
    if (kDebugMode) {
      SharedPreferences.getInstance().then((prefs) {
        print('======================================');
        print('BEARER TOKEN: ${prefs.getString(AppConstants.token)}');
        print('======================================');
      });
    }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      backgroundColor: theme.colorScheme.surface, // M3 Surface
